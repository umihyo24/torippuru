...
import {
  applyTraitEffects as applyTraitEffectsImpl,
  resolveUnitOnEnterEffects as resolveUnitOnEnterEffectsImpl,
...
(() => {
  ...
  const applyTraitEffects = (eventType, context = {}) => applyTraitEffectsImpl({
    eventType,
    context,
    getSelectedTrait,
    TRAIT_LIBRARY,
  ...
  const resolveUnitOnEnterEffects = ({ state, team, slot, unit }) => resolveUnitOnEnterEffectsImpl({
    state,
    team,
    slot,
    unit,
